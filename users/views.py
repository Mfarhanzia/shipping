        ...
        if request.method=="POST":
            if request.POST.get('selector','') == "True":
                ...
                if user.company_name:
                    ...
                    messages.success(request, f'You have Given Access to {user.first_name} {user.last_name} and an email is sent to user.')
                ...
                try:
                    ...
                    if user.company_name:
                        ...
                        messages.success(request, f'You have Rejected Access to {user.first_name} {user.last_name}')
                except:
                    pass
                return redirect('register')       
            else:

    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('when_to_order', models.CharField(choices=[('urgent', 'Urgent(within 30 days)'), ('other', 'Other (days)')], default=None, max_length=50, verbose_name='When are you looking to order?')),
                ('other_when_to_order', models.PositiveIntegerField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(31)], verbose_name='Other (days)')),
